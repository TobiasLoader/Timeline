...
function setupPeople(){
	people = {
	  	...
	  	'Toby2': new Person(
	  		'Toby2',
	  		new Human(38,76,color(9, 154, 176)),
	  		toby.x,
	  		ground-38,
	  		8.5,
	  		false),
	  	'Toby3': new Person(
	  		'Toby3',
	  		new Human(45,90,color(9, 131, 176)),
	  		toby.x,
	  		ground-40,
	  		9,
	  		false),
	  	'Toby4': new Person(
	  		'Toby4',
	  		new Human(50,100,color(9, 101, 176)),
	  		toby.x,
	  		ground-50,
	  		10,
	  		false),
	  	'Toby5': new Person(
	  		'Toby5',
	  		new Human(60,120,color(9, 67, 176)),
	  		toby.x,
	  		ground-60,
	  		11,
	  		false),
	  	'Toby6': new Person(
	  		'Toby6',
	  		new Human(70,140,color(73, 9, 176)),
	  		toby.x,
	  		ground-70,
	  		12,
	  		false),
	  	'Toby7': new Person(
	  		'Toby7',
	  		new Human(80,150,color(176, 62, 9)),
	  		toby.x,
	  		ground-75,
	  		12,
	  		false),
	  	'Toby8': new Person(
	  		'Toby8',
	  		new Human(85,156,color(176, 120, 9)),
	  		toby.x,
	  		ground-78,
	  		12,
	  		false),
	  	'Toby9': new Person(
	  		'Toby9',
	  		new Human(90,160,color(101, 176, 9)),
	  		toby.x,
	  		ground-80,
	  		12,
	  		false),
	  	'Toby10': new Person(
	  		'Toby10',
	  		new Human(92,166,color(9, 176, 137)),
	  		toby.x,
	  		ground-83,
	  		12,
	  		false),
